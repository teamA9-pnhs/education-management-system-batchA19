...
urlpatterns = [
    ...
    path('add_subj_open_electives/', HodViews.add_subj_open_electives, name="add_subj_open_electives"),
    path('add_subj_open_electives_save/', HodViews.add_subj_open_electives_save, name="add_subj_open_electives_save"),
    path('manage_subj_open_electives/', HodViews.manage_subj_open_electives, name="manage_subj_open_electives"),
    path('edit_subj_open_electives/<subject_id>/', HodViews.edit_subj_open_electives, name="edit_subj_open_electives"),
    path('edit_subj_open_electives_save/', HodViews.edit_subj_open_electives_save, name="edit_subj_open_electives_save"),
    path('delete_subj_open_electives/<subject_id>/', HodViews.delete_subj_open_electives, name="delete_subj_open_electives"),
    ...
    path('open_electives/',HodViews.open_electives, name="open_electives"),
